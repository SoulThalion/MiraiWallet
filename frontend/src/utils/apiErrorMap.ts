...
const ERROR_CODE_TO_I18N_KEY: Record<number, string> = {
  ...
  5019: 'errors.profile.recurringSavingsPatternKeysInvalid',
  5020: 'errors.profile.recurringSavingsPatternKeyInvalid',
  5021: 'errors.profile.recurringSavingsCategoryIdsInvalid',
  5022: 'errors.profile.recurringSavingsCategoryIdInvalid',
  5023: 'errors.profile.recurringSavingsCategoryUnknown',
