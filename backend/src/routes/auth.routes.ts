...
import {
  registerRules, loginRules, refreshRules, changePasswordRules, wipeFinancialDataRules,
  updateProfileRules,
...
router.patch('/me',           authenticate, updateProfileRules, validate, ctrl.updateProfile)
